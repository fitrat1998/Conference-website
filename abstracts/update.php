...
include '../config.php';
 ...
 $sql = mysqli_query($con,"SELECT * FROM submit WHERE id = '$id'");
...
<html>
<head>
	<title>SISM 2023 | Updating uploaded file</title>
</head>
<body>
                ...
                <div class="card-body">
                   ...
                   <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" type="text" placeholder="abstracts" id="" name="abstract" required autofocus value=""><?=$res['abstracts'];?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea class="form-control" type="text" placeholder="keywords" id="" name="keyword" required autofocus value=""><?=$res['keywords'];?></textarea>
                        </div>
                    </div>
