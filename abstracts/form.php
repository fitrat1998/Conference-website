...
// exit();
    ...
    $id = $_POST['id']; 	
 	$dir = "files/";
 	$sql2 = mysqli_query($con,"SELECT file FROM submit WHERE id='$id'");
 	...
 	else $error = "Plese enter your abstracts";

 	if(!empty($_POST['keyword']))  $keyword = trim($_POST['keyword']);
 	else $error = "Plese enter your keywords";
   ...
   $file_exp = strtolower(end(explode(".", $_FILES['file']['name'])));
    ...
    $sql = "UPDATE submit SET first_name = '$first_name',last_name = '$last_name',abstracts='$abstract',keywords='$keyword',file='$file' WHERE id = '$id'";
