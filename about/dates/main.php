...
<li>
	...
	<span class="active">Important dates</span>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a class="list-group-item active" href="index.php">Important dates</a>
	...
	<tbody>
		<tr>
			<th style="padding: 5px; text-align: right; width: 450px;">Second announcement</th>
			<td style="padding: 5px;">March 15</td>
		</tr>
		<tr>
			<th style="padding: 5px; text-align: right;">Deadline for registration and submission of abstracts</th>
			<td style="padding: 5px;">June 1</td>
		</tr>
		<tr>
			<th style="padding: 5px; text-align: right;">Deadline for submission of visa application</th>
			<td style="padding: 5px;">June 1</td>
		</tr>
		<tr>
			<th style="padding: 5px; text-align: right;">Deadline for submission of manuscripts</th>
			<td style="padding: 5px;">July 1</td>
		</tr>
	</tbody>
</table>
        </div>
