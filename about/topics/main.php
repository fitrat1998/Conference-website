<main role="main"><br/>
    <div class="container">
        <div class="row">
            <div class="col-2 reponsive_block">
        ...
        <div class="col-lg-12">
            <ol class="breadcrumb">    
               <li>
                ...
                <li>
                 <span class="active">Main topics</span>
                </li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Main topics</h1>
        </div>
    </div>
    <!-- /.row -->
    <!-- Content Row -->
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                <a class="list-group-item active" href="index.php">Main topics</a>
                ...
                <a class="list-group-item" href="../visa/index.php">VISA</a>
             </div>
        </div>
        <!-- Content Column -->
        <div class="col-md-9">
            <ol>
              <li>Spintronics and Magnetotransport </li>
              <li>Magnetophotonics (linear and nonlinear magnetooptics, magnetophotonic crystals)</li>
              <li>High Frequency Properties and Metamaterials </li>
              <li>Diluted Magnetic Semiconductors and Oxides</li>
              <li>Magnetic Nanostructures and Low Dimensional Magnetism</li>
              <li>Magnetic Soft Matter (magnetic polymers, complex magnetic fluids and suspensions)</li>
              <li>Soft and Hard Magnetic Materials</li>
              <li>Magnetic Shape-memory Alloys and Magnetocaloric Effect</li>
              <li>Magnetism and Superconductivity</li>
              <li>Multiferroics</li>
              <li>Magnetism in Biology and Medicine</li>
              <li>Miscellaneous</li>
           </ol>
        </div>
    </div>
