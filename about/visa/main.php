<main role="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-2 responsive_block">
                <img src="../../static/mism2020/images/mism_logo_2020_300.png" style="width: 150px" alt="MISM 2020 Logo">
            </div>
            <div class="col-10">
                <h2 class="page-header">SISM International Symposium on Magnetism 2023<br/>
...
<li>
	...
	<a href="../../index.php">Home</a> <span class="separator">&raquo;</span>
	
</li>

<li>
	
	<a href="../index.php">About</a> <span class="separator">&raquo;</span>
...
<li>
    ...
    <div class="row">
        <!-- Sidebar Column -->
         <div class="col-md-3">
            <div class="list-group">
                <a class="list-group-item " href="../topics/index.php">Main topics</a>
                <a class="list-group-item " href="../dates/index.php">Important dates</a>
                <a class="list-group-item " href="../fees/index.php">Registration fees</a>
                <a class="list-group-item " href="../plenary/index.php">Plenary speakers</a>
                <a class="list-group-item " href="../abstracts/index.php">Submission of abstracts</a>
                <a class="list-group-item active" href="index.php">VISA</a>
        ...
        <!-- Content Column -->
        <div class="col-md-9">
            <p class="text-justify">There is no VISA to Uzbekistan for participants from most countries.Organiserss will provide the support letter for getting VISA to everyone need it.</p>

<!-- <p class="text-justify">In case if tourist visa is not suitable, you can request a so called <strong>humanitarian visa</strong>. For this purposes we will provide you with the official invitation issued by Lomonosov Moscow State University or Federal migration service (depending on the country of residence), but please be aware that preparation of this invitation might take up to 45-60 days. If you decide to apply for such kind of visa, please send us the following information through the page <a href="../../accounts/visa/index.php">Visa application</a>:</p>

<ul>
	<li class="text-justify">the copy of your passport</li>
	<li class="text-justify">filled form with information</li>
	<li class="text-justify">and specify the place in your country where you apply for visa</li>
</ul>

<p class="text-justify">Please draw your attention to deadline for such request (<u>May 15, 2020</u>) – due to the time required for procedure to receive this document, we will not be able to guarantee that this special invitation for visa will be issued on time if the request will be sent after the deadline.</p>

<p class="text-justify"><br>
The information on how to apply for Russian visa in your country can be found on the webpage of Embassy of the Russian Federation  and Russian visa office. You can also address any travel agency of your choice.<br>
<br>
In case of additional questions please feel free to contact us (<a href="mailto:mail@magn.ru?subject=Visa application question">mail@magn.ru</a>), we will be happy to help you with arrangement of your trip to Moscow.</p> -->
        </div>
    </div>
    <!-- /.row -->
