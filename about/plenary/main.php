...
<li>
  ...
  <span class="active">Plenary speakers</span>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="" style="margin-left:290px!important;">Plenary speakers</h1>
        </div>
    </div>
    <!-- /.row -->
        ...
        <!-- Sidebar Column -->
          <div class="col-md-3">
            <div class="list-group">
                ...
                <a class="list-group-item active" href="index.php">Plenary speakers</a>
