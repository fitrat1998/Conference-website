<?php
   ...
   $sql = mysqli_query($con,"SELECT last_name FROM users WHERE id = '$id' ");
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="list-group">
                 ...
                 <a class="list-group-item active" href="index.php">Payment</a>
        ...
        <!-- Content Column -->
        <div class="col-md-6">
        <h2 style="text-align: center;" class="text-justify">Purpose of payment</h2>
        <p>Organizing FEE FOR Samarkand International Symposium on magnetism from <span style="font-size:34px;color:#008080;"><?=$res['last_name'];?></span></p>


        <h2 style="text-align: center;" class="text-justify"><h1>Attention</h1></h2>

<p>
  Credit cards <u>"MIR"</u> are not accepted in Uzbekistan.<br>
  In the case of problem with payment <br>
  for bookinghotel and organizing fees<br>
 in advance please use cash money on site after arriving.<br>
 </p>
<h1>Accounts Information</h1>
<p>
Transfer in EURO 978 to Samarkand State University.<br>
Beneficiary account number: 400910978184017094100079003
Beneficiary name: Ministry of Finance of the Republic of Uzbekistan
Address: 29, Istiqlol str., Tashkent, 100017, Uzbekistan
Bank: Central Bank of the Republic of Uzbekistan
Cor. account: 23402978900100001001<br>
SWIFT: CBUZUZ22<br>
