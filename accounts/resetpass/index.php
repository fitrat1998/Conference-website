   ...
   <div class="row">
      <div class="col-lg-4 offset-lg-4">
         <div class="card">
            ...
            <div class="card-body">
               <form method="post" action="#" class="" id="reset">
                  ...
                  <div class="form-group">
                     <div class="input-group">
                        ...
                        <input class="form-control" type="text" placeholder="Email" id="id_email" name="email" required>
                     </div>
                  </div>
                  <br/>
                  <button class="btn btn-block btn-danger" type="submit" value="login">Reset my password</button>
               </form>
            </div>
         </div>
      </div>
