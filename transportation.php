   ...
   document.querySelector(".reposiv__menu-block-icon-add").addEventListener("click", ()=>{
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-10">
                <h1 class="page-header"><i class="fa-solid fa-train"></i> Transportation <i class="fa-solid fa-car"></i><br/>
               </h1>
               <h4>  The transfer from Tashkent airport to hotels in Tashkent and Tashkent railway station will be organized  by  request.</h4>
               <h4> The transfrer from Samarkand airport and Samarkand railway station to conference site will be organized by request.</h4>
                <hr>
                </div>
            </div>
...
<!-- your codes here -->
            <table class="table table-hover">
                <h4 style="text-align:center;">Train <i class="fa-solid fa-train"></i></h4>
              <thead class="thead-green">
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">From Tashkent</th>
                  <th scope="col">To Samarkand</th>
                  <th scope="col">Voyage <i class="fa-solid fa-train"></i></th>
                </tr>
              </thead>
              <tbody>
                <tr>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>07:28</td>
                  <td>09:36</td>
                  <td>everyday (during 9:36-9:44 in Samarkand) </td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td>8:00</td>
                  <td>10:30</td>
                  <td>Till sunday (during 10:08-10:16 in Samarkand) </td>
                </tr>
              </tbody>
            </table>
            <hr>
            <!-- end of train section -->
              ...
              <table class="table table-hover">
                <h4 style="text-align:center;">Car <i class="fa-solid fa-car"></i></h4>
              <thead class="thead-green">
                <tr>
                  <th scope="col">#</th>
                  <th scope="col">From station</th>
                  <th scope="col">To accommodation</th>
                  <th scope="col">Voyage <i class="fa-solid fa-train"></i></th>
                </tr>
              </thead>
              <tbody>
             ...
             <table class="table table-hover">
              <thead class="thead-green">
                <tr>
                  ...
                  <th scope="col">From station</th>
                  <th scope="col">To accommodation</th>
                  <th scope="col">Voyage <i class="fa-solid fa-car"></i></th>
                </tr>
              </thead>
              <tbody>
                <tr>
             ...
             <table class="table table-hover">
              <thead class="thead-green">
                <tr>
                  ...
                  <th scope="col">From station</th>
                  <th scope="col">To accommodation</th>
                  <th scope="col">Voyage <i class="fa-solid fa-bus"></i></th>
                </tr>
              </thead>
              <tbody>
                <tr>
