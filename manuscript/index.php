...
<main role="main">
    ...
    <div class="row">
        <div class="col-lg-4 offset-lg-4">
            <div class="card">
                <div class="card-header"><i class="fa fa-bracket" aria-hidden="true" style="margin-left:120px;"></i> Manuscript</div>
                <div class="card-body">
                    <form method="post" class="margin-top-md" action="" class="" enctype="multipart/form-data" id="manuscript">
 ...
 <strong align="center" style="margin-left: 200px !important; color:red;" >  In the case of any problem with submission of manuscripts please send it by email  <span><a href="mailto:mism@magn.ru">mism@magn.ru</a></span></strong>
        <hr>
