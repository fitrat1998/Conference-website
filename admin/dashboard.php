<?php
  ...
  $sql2 = mysqli_query($con,"SELECT * FROM manuscripts");
  $script =  mysqli_num_rows($sql2);

  $sql3 = mysqli_query($con,"SELECT * FROM submit");
  $abstracts = mysqli_num_rows($sql3);
...
<html lang="en">
  <head>
    ...
    <title>SISM 2023 | Admin dashboard</title>
    <meta charset="utf-8">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="dashboard.php"><i class="fa fa-user fa-lg"></i><?=$_SESSION['name'];?></a></li>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item active" href="dashboard.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
            ...
            <li><a class="app-menu__item " href="data-table.php"><i class="app-menu__icon  fa fa-user"></i><span class="app-menu__label">Registred users</span></a></li>
         

      
            <li><a class="app-menu__item " href="abstracts.php"><i  class="app-menu__icon  fa fa-files-o"></i>        <span class="app-menu__label">Upload abstracts</span></a></li>

            <li><a class="app-menu__item " href="manuscripts.php"><i  class="app-menu__icon  fa fa-files-o"></i>        <span class="app-menu__label">Upload manuscripts</span></a></li>
