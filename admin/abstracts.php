<?php
  ...
  $sql = mysqli_query($con,"SELECT * FROM submit");
  $res = mysqli_fetch_assoc($sql);

  $abstracts =  mysqli_num_rows($sql);
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="dashboard.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
            ...
            <li class=""><a class="app-menu__item active" href="abstracts.php"><i  class="app-menu__icon  fa fa-files-o"></i>        <span class="app-menu__label">Upload abstracts</span></a></li>
        </li>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$res['email']?></td>
                      <td><?=$res['phone']?></td>
                      <td><a href="../abstracts/files/<?=$res['file']?>"><?=$res['file']?></a></td>
                    </tr>
                  <? } ?>
                  </tbody>
                </table>
