...
<html lang="en">
  <head>
    ...
    <title>SISM 2023 | Registered users</title>
    <meta charset="utf-8">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="data-table.php"><i class="fa fa-user fa-lg"></i><?=$_SESSION['name'];?></a></li>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li><a class="app-menu__item " href="dashboard.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Home</span></a></li>
            ...
            <li class=""><a class="app-menu__item active" href="data-table.php"><i class="app-menu__icon  fa fa-user"></i><span class="app-menu__label">Registred users</span></a></li>
            ...
            <li class=""><a class="app-menu__item " href="manuscripts.php"><i  class="app-menu__icon  fa fa-files-o"></i>        <span class="app-menu__label">Upload manuscripts</span></a></li>
...
<div class="app-title">
          <div>
            <h1><i class="fa fa-dashboard"></i>List of registered users</h1>
          </div>
