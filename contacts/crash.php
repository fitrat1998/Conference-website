    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <small>June 27 - July 2, 2023</small></h2>
                <hr>
...
<p><abbr title="Phone"><i class="fa fa-phone"></i> </abbr>: coming soon</p>

<p><abbr title="Email"><i class="fa fa-at"></i> </abbr>: <a href="mailto:mism@magn.ru">comming soon</a></p>
</address>
        </div>
    </div>
    <!-- /.row -->
